...
class OfferProductAdapter(private val onProductClick: (Int) -> Unit, private val onFavoriteClick: (ProductUI) -> Unit): ListAdapter<ProductUI, OfferProductAdapter.ProductViewHolder>(ProductDiffUtilCallBack()) {

    // Class for horizontal recycler view (Current Offers)
        ...
        fun bind(product: ProductUI) {
            with(binding) {
                ...
                favImageView.setBackgroundResource(
                    if (product.favState) R.drawable.ic_favorite
